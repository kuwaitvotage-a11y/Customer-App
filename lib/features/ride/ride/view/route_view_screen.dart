...
class _RouteViewScreenState extends State<RouteViewScreen> {
  ...
  void _startDriverLocationTracking() {
    ...
    _driverLocationSubscription = Constant.driverLocationUpdateCollection
      ...
      if (!event.exists) {
        showLog('🗺️ Customer Map - Driver location document does not exist!');
        return;
      }

      showLog('🗺️ Customer Map - Received driver location update from Firebase');
      ...
      if (mounted) {
        setState(() {
          ...
          if (driverLat != 0.0 && driverLng != 0.0) {
            ...
            showLog('🗺️ Customer Map - Taxi icon loaded: ${taxiIcon != null}');
